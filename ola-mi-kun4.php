...
if(isset($_POST["submit"])) {
	...
	$sql_1 = "INSERT INTO ola_mi_kun_4_comments (first_name, last_name, comment, date) VALUES ('$first_name', '$last_name', '$comment', '$date');";
	$query = mysqli_query($conn, $sql_1); 
}


$sql = "SELECT * FROM ola_mi_kun_4_comments";
...
$author = "Ola Mi Kun";
$content = "Will you be mine ?I asked, she stared at me for few minutes and said, yes, of course,swii 💖. I put the ring on her finger and kissed her again, I just so much love her scent, touch and everything about her ( I hate ladies touching me but the more she touches me, the more I wanna hold her in my arms with her head on my chest forever and ever) <br><br>
Serena's POV <br><br>
...
Mirabel,sorry ooooo, u don receive mafia lord slap, how is your face bayi 🤣😅. Team Mirabel or team Serena? ";
