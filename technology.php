				...
				<h1>TECHNOLOGY</h1>
					<div> 
						<div class="popular-posts-wrapper">
							<div class="popular-posts-img" style="background: url(images/neha-gupta.jpg);
							...
							<div class="popular-posts">
								<h2>2 Easy Ways How To Run Windows On Mac</h2>
								<h4>November 2021</h4>
								<h4>Neha Gupta</h4>
								<p>Mac has now added an advantage that was much awaited. It is now totally possible to use Windows and other operating systems on your Mac...</p>
								<p><a href="neha-gupta.php">Continue reading --></a></p>
							</div>
						</div> 
						<div class="popular-posts-wrapper">
							<div class="popular-posts-img" style="background: url(images/shipra-prajapati.jpg);
																								background-size: cover;
																								background-position: center;
																								width: 20rem;
																								height: 15rem;">
							...
							<div class="popular-posts">
								<h2>Wondering Why iPhone Won't Connect To Wi-Fi? Read This Guide</h2>
								<h4>October 2021</h4>
								<h4>Shipra Prajapati</h4>
								<p>There might be a situation when your iPhone won’t connect to Wi-Fi. This is a common error but it may frustrate and leave you clueless about how to fix it. This post will elaborate on simple solutions that you can try when your iPhone doesn’t connect to Wi-Fi....</p>
								<p><a href="shipra-prajapati.php">Continue reading --></a></p>
							</div>
						</div> 	
						<div class="popular-posts-wrapper">
							<div class="popular-posts-img" style="background: url(images/gopal-tiwari.jpg);
																								background-size: cover;
																								background-position: center;
																								width: 20rem;
																								height: 15rem;">
							...
							<div class="popular-posts">
								<h2>MoviesCouch: Download Your Favourite Movies Instantly</h2>
								<h4>October 2021</h4>
								<h4>Gopal Tiwari</h4>
								<p>We all know that it is not easy to download any new Bollywood or Hollywood film from the internet. But, thanks to moviescouch, an unlawful website that distributes pirated films....</p>
								<p><a href="gopal-tiwari.php">Continue reading --></a></p>
							</div>
						</div> 					
					</div> 
