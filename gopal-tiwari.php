...
if(isset($_POST["submit"])) {
	...
	$sql_1 = "INSERT INTO gopal_tiwari_comments (first_name, last_name, comment, date) VALUES ('$first_name', '$last_name', '$comment', now());";
	$query = mysqli_query($conn, $sql_1); 
}


$sql = "SELECT * FROM gopal_tiwari_comments";
$query = mysqli_query($conn, $sql);
$result = mysqli_fetch_all($query, MYSQLI_ASSOC);
 
$title = "MOVIESCOUCH: DOWNLOAD YOUR FAVOURITE MOVIES INSTANTLY";
$date = "October 2021";
$author = "Gopal Tiwari";
$content = "We all know that it is not easy to download any new Bollywood or Hollywood film from the internet. But, thanks to moviescouch, an unlawful website that distributes pirated films. MoviesCouch is an excellent programme for this purpose. This platform allows you to watch and download your favourite movies and television episodes. It is a free website that allows anyone to watch the most recent movies and television episodes, even though it is illegal.
...
<br><br>
MoviesCouch 2021: A Comprehensive Movie Collection
moviescouch.com is a well-known pirated website where users can download Hindi Dubbed Films, 300MB Films, and other stuff.
...
<br><br>
moviescouch.com is a pirated website that is frequently restricted or changes domain names. If you can't go to moviescouch, you can try one of the other domain names listed above.
