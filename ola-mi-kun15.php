...
if(isset($_POST["submit"])) {
	...
	$sql_1 = "INSERT INTO ola_mi_kun_15_comments (first_name, last_name, comment, date) VALUES ('$first_name', '$last_name', '$comment', '$date');";
	$query = mysqli_query($conn, $sql_1); 
}


$sql = "SELECT * FROM ola_mi_kun_15_comments";
