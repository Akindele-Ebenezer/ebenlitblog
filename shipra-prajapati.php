...
if(isset($_POST["submit"])) {
	...
	$sql_1 = "INSERT INTO shipra_prajapati_comments (first_name, last_name, comment, date) VALUES ('$first_name', '$last_name', '$comment', '$date');";
	$query = mysqli_query($conn, $sql_1); 
}


$sql = "SELECT * FROM shipra_prajapati_comments";
