				...
				<h1>POEMS</h1>
					<div>
						<div class="popular-posts-wrapper">
							<div class="popular-posts-img" style="background: url(images/curtis.jpg);
							...
							<div class="popular-posts">
								...
								While the armour remains on you
								....
									</p>
								<p><a href="curtis.php">Continue reading --></a></p>
							</div>
						</div>
						<div class="popular-posts-wrapper">
							<div class="popular-posts-img" style="background: url(images/tina.jpg);
																background-size: cover;
																background-position: center;
																width: 20rem;
																height: 15rem;">
							...
							<div class="popular-posts">
								...
								<p><a href="tina.php">Continue reading --></a></p>
							</div>
						</div>
						<div class="popular-posts-wrapper">
